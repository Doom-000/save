                    ...
                    {orders.map((order) => {
                      ...
                      return (
                        <div 
                          ...
                          className="p-3 hover:bg-[#F9F8F6] dark:hover:bg-black/20 transition-colors flex items-start gap-3 cursor-pointer"
                        >
...
fs.writeFileSync('src/components/AdminOrderNotifications.tsx', code, 'utf8');
